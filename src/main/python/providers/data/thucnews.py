...
# Default THUCNews HF repo (override via env)
_THUCNEWS_HF_REPO_DEFAULT = "madao33/new-title-chinese"
_THUCNEWS_HF_SPLIT_DEFAULT = "train"
...
class THUCNewsLoader(BaseDataSource):
    ...
    def __init__(
        ...
        self.hf_repo = hf_repo or os.environ.get("THUCNEWS_HF_REPO", _THUCNEWS_HF_REPO_DEFAULT)
        self.split = split or os.environ.get("THUCNEWS_HF_SPLIT", _THUCNEWS_HF_SPLIT_DEFAULT)
