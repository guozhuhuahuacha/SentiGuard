...
TEST_CLAIMS = [
    ...
    # ---- 鹅腿阿姨（2023年北大清华学生排队抢购社会热点）----
    {
        "claim": "2023年，北京大学和清华大学的学生排队购买一位阿姨的烤鹅腿，使该阿姨走红网络。",
        "expected": "supported",
        "category": "社会热点",
        "note": "2023年11月，清华北大附近卖烤鹅腿的阿姨因学生排队抢购而走红，登上热搜",
    },

    # ---- 鹅腿阿姨 假货/误导类（预期 not_supported）----
    {
        "claim": "走红后的鹅腿阿姨被查出使用劣质鸭肉冒充鹅肉，属于卖假货。",
        "expected": "not_supported",
        "category": "社会热点",
        "note": "鹅腿阿姨走红后并无官方通报其卖假货/以鸭充鹅；此类说法缺乏证据，属网络传言",
    },

    # ---- AI / 科技 ----
    {
        "claim": "2024年诺贝尔化学奖授予了与蛋白质结构预测相关的科学家。",
        "expected": "supported",
        "category": "科技事实",
        "note": "2024年诺贝尔化学奖授予 AlphaFold 相关工作（Hassabis、Jumper、Baker）",
    },

    {
        "claim": "中国嫦娥六号任务在2024年从月球背面带回了土壤样品。",
        "expected": "supported",
        "category": "科技事实",
        "note": "2024年6月嫦娥六号完成人类首次月球背面采样返回",
    },

    # ---- 经典谣言（预期 not_supported）----
    {
        "claim": "5G基站的辐射会导致新冠状病毒传播。",
        "expected": "not_supported",
        "category": "网络谣言",
        "note": "5G辐射与新冠病毒无关，此为已被辟谣的阴谋论",
    },
]
